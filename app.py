...
df = pd.read_csv('C:/Users/nagkisho/Downloads/AI-Interview-master/AI-Interview-master/WebApp/static/js/db/histo.txt',
                 sep=",")
...
def video_dash():
    ...
    df_2 = pd.read_csv(
        'C:/Users/nagkisho/Downloads/AI-Interview-master/AI-Interview-master/WebApp/static/js/db/histo_perso.txt')
    ...
    df_perso.to_csv(
        'C:/Users/nagkisho/Downloads/AI-Interview-master/AI-Interview-master/WebApp/static/js/db/hist_vid_perso.txt',
        sep=",", index=False)
    ...
    df_glob.to_csv(
        'C:/Users/nagkisho/Downloads/AI-Interview-master/AI-Interview-master/WebApp/static/js/db/hist_vid_glob.txt',
        sep=",", index=False)
    ...
    ### Altair Plot
    df_altair = pd.read_csv(
        'C:/Users/nagkisho/Downloads/AI-Interview-master/AI-Interview-master/WebApp/static/js/db/prob.csv', header=None,
    ...
    chart.save('C:/Users/nagkisho/Downloads/AI-Interview-master/AI-Interview-master/WebApp/static/js/db/chart.html')
